...
const en: Dict = {
  ...
  packages: {
    ...
    items: [
      {
        name: "You describe. It builds.",
        type: "",
        desc: "Describe the hardware you want in natural language. The agent breaks it into tasks and runs the full loop.",
      },
      {
        name: "You watch. It runs.",
        type: "",
        desc: "Every step — sourcing, CAD, PCB, firmware, assembly — is visible. Step in when you need to. Let it run when you don't.",
      },
      {
        name: "You receive. It delivers.",
        type: "",
        desc: "You get a complete project package: design files, BOM, firmware code, assembly guide. Print it out — you now have a device that's yours.",
      },
    ],
  },
  faq: {
    ...
    items: [
      {
        name: "你说，它做",
        type: "",
        desc: "自然语言描述你想要的硬件，Agent 自己拆任务、跑流程。",
      },
      {
        name: "你看，它跑",
        type: "",
        desc: "每一步——选型、CAD、PCB、固件、装配——你都能看见。需要介入时你介入，不需要时它继续跑。",
      },
      {
        name: "你收，它交付",
        type: "",
        desc: "最终你拿到一份完整的项目包：设计文件、BOM 清单、固件代码、装配引导。打印一份，你就有了一台属于你自己的设备。",
      },
    ],
  },
  faq: {
